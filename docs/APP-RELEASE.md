...
- **Push („du bist dran")** gebaut und aus (`docs/PUSH.md`): Server
  (Tabelle `geraet_push`, APNs/FCM-Sender, drei Anlässe), Client und
  Android-Seite (4.10) sind fertig. Es fehlen der APNs-Schlüssel aus Toms
  Konto, ein Firebase-Projekt und die iOS-Seite der Brücke.
