...
> (`screens/Tafelrunde.tsx`), die den Regelsatz an den Tisch schickt. Gemessen
> nachher: **7:25 im Median bei 11 Runden**, einzelner Kampf 17,3 s, 1,8 % der
> Kämpfe von der Uhr entschieden. Die Zahlen stehen in **Abschnitt 5**; alles
...
bekommt die Tabelle aus Abschnitt 5, weil „wie gebaut" inzwischen die
Empfehlung ist. Jede Zeile rechnet dieselben 500 Saaten — ein Unterschied zwischen zwei Zeilen ist die Wirkung
...
**Erledigt ist das mit dem Zeitraffer**, nicht mit einer neuen Grenze: 1,8 %
statt 27,7 %, siehe Abschnitt 5. Die Begründung an `HOECHSTDAUER_MS` sagt
