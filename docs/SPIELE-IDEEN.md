...
| --- | --- | --- |
| **Poker (Spielgeld)** | 0,5–0,7 | **Seit 25.8.2026 als „Easy Poker“ auf `staging`**, ab 27.8. **2–6 Sitze** (6-max Online-Tisch). Die Einwände bleiben gültig und sind der Grund für den Zuschnitt. Die Jetons sind Partiepunkte: kein Kauf, kein Umtausch, keine Verbindung zu Münzen oder Edelsteinen, damit `game-api`-Grundsatz 4 (Regelwerk und Währung getrennt) hält. Die Apple-Frage ist damit **nicht** erledigt: Auch ohne echtes Geld kann eine Glücksspiel-Nachbildung Altersfreigabe kosten und in einzelnen Ländern gesperrt werden. Vor der Einreichung im App Store ist das zu entscheiden — notfalls bleibt Easy Poker auf der Webausgabe. Bildbestellung `docs/ASSETS-EASYPOKER.md` verbietet deshalb Geld- und Spielbank-Motive. |
