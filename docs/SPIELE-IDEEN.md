...
| --- | --- | --- |
| **Poker (Spielgeld)** | 0,5–0,7 | **Seit 25.8.2026 als „Poker“ auf `staging`**, ab 27.8. **2–6 Sitze**, ab 27.8. abends **BroJetons**. Der Host stellt Mindest-Einsatz und Blinds. BroJetons kauft man im Shop gegen Münzen; zurück in Münzen oder Edelsteine gehen sie nicht — das hält `game-api`-Grundsatz 4 (das Regelwerk kennt Zahlen, die Plattform den Beutel). Die Apple-Frage bleibt offen: Auch ohne echtes Geld kann eine Glücksspiel-Nachbildung Altersfreigabe kosten. Vor der Einreichung im App Store ist das zu entscheiden — notfalls bleibt Poker auf der Webausgabe. Bildbestellung `docs/ASSETS-EASYPOKER.md` verbietet deshalb Geld- und Spielbank-Motive. |
