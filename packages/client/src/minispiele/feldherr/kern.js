 ...
 * (kern-erzeugen.mjs) lenkt sie um und meldet den Befehl als Zug für einen
 * künftigen Takt, statt ihn auszuführen. Zwischen Eingabe und Ausführung
 * liegen dann sechs Takte — was beim Antippen noch galt, kann vorbei sein.
 * Deshalb prüft jede Funktion ihre Voraussetzungen SELBST und verpufft
 * still, wenn sie nicht mehr gelten: auf beiden Geräten gleich. */
...
function drehBefehl(own){ G.orient[own] = !G.orient[own]; syncHUD(); }
