...
/** Einmal nach dem Aufbau die Kamera ausrichten und die Leinwand anstossen. */
function KameraUndAnstoss(): null {
  const { camera } = useThree();
  useEffect(() => {
    camera.lookAt(SPALTEN / 2, 0, ZEILEN / 2 + 0.8);
  ...
  return (
    ...
    >
      ...
      <Canvas
        ...
        camera={{ position: [SPALTEN / 2, 11.5, ZEILEN + 4.2], fov: 42 }}
      >
