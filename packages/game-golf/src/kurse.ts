...
'k41-rueckenwind': ['beschleuniger'],
  'k42-die-strudelpfuetze': ['sand', 'strudel'],
  'k43-der-erste-huepfer': ['sprungfeld'],
  'k44-turbo-auf-dem-eis': ['beschleuniger', 'bumper', 'eis', 'sand'],
  'k45-die-drehtuer': ['drehkreuz'],
  'k46-portal-in-den-strudel': ['portal', 'strudel'],
  'k47-sprung-ueber-den-bach': ['sand', 'sprungfeld', 'wasser'],
  'k48-kreiselallee': ['sand', 'strudel'],
  'k49-zwei-drehtueren': ['drehkreuz'],
  'k50-turbokurve': ['beschleuniger', 'eis', 'sand'],
  'k51-strudelschleuder': ['strudel'],
  'k52-duenenhuepfer': ['sand', 'sprungfeld'],
  'k53-portal-im-wirbel': ['bumper', 'portal', 'strudel'],
  'k54-die-schleuse': ['beschleuniger', 'bumper', 'drehkreuz', 'sand'],
  'k55-der-seesprung': ['beschleuniger', 'sand', 'sprungfeld', 'wasser'],
  'k56-eisstrudelkammer': ['bumper', 'eis', 'sand', 'strudel'],
  'k57-wirbelportal': ['bumper', 'portal', 'sand', 'strudel'],
  'k58-wirbelsturm': ['bumper', 'drehkreuz', 'sand', 'strudel'],
  'k59-eisturbine': ['beschleuniger', 'bumper', 'eis', 'sand', 'sprungfeld', 'wasser'],
  'k60-neunerlei': ['beschleuniger', 'bumper', 'drehkreuz', 'eis', 'portal', 'sand', 'sprungfeld', 'strudel', 'wasser'],
};
